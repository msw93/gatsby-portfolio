    ...
    <section id='intro' className = "pa3 center tc">
    	<Fade duration={1000} delay={800} distance="30px">
    		<div className="flex-l flex-m justify-center-l justify-center-m items-center-l items-center-m w-100">
    			<div className='fl-l fl-m fc w-50-l w-50-m w-100 bg-white pa3 pt0 shadow-1'>
    				<h1 className='pt3'>Michael Winer, Front End Web Developer, Super Hero and more.</h1>
    				<p>Welcome, click <LocalButton className="pb2" to="/resume">HERE</LocalButton> or my face for my <b>resume</b></p>
    			</div>
    			<div className='fl-l fl-m fc w-30-l w-30-m w-100 tc pa3'>
